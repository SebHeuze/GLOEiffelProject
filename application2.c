...
r40put_string(&ds,se_i40(&ds,((T40*)ci(40,r25io(&ds,C),0x03203508/*l53c4\application.e*/))),r122last(&ds,se_i122(&ds,((T122*)ci(122,_contenu_fichier,0x03203524/*l53c18\application.e*/)))));
...
(ds.p=0x03203C10/*l60c8\application.e*/);
r40put_integer(&ds,se_i40(&ds,((T40*)ci(40,r25io(&ds,C),0x03203C0A/*l60c5\application.e*/))),/*IC*/(T11)(_i));
(ds.p=0x03203D0A/*l61c5\application.e*/);
...
void se_msi1(void){
ms52_117797837=se_ms(10,s52_117797837);
}/*--*/

void manifest_string_mark1(void){
gc_mark7((T7*)ms52_117797837);
}/*--*/
...
int se_strucT[124]={0,sizeof(T1),sizeof(T2),sizeof(T3),0,0,sizeof(T6),sizeof(T7),sizeof(T8),sizeof(T9),sizeof(T10),sizeof(T11),
0,
0,
0,
0,
